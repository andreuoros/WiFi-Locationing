...
angle=np.arctan(traintransf['LATITUDE'][0]/traintransf['LONGITUDE'][0])
angle=angle/math.pi
#trainingDatawoduplicates['LONGITUDE']=-trainingDatawoduplicates['LONGITUDE']
LONGITUDE = traintransf['LONGITUDE']*np.cos(angle) + traintransf['LATITUDE']*np.sin(angle)
LATITUDE = traintransf['LATITUDE']*np.cos(angle) - traintransf['LONGITUDE']*np.sin(angle)
plt.scatter(LONGITUDE,LATITUDE)
traintransf['LONGITUDE']=LONGITUDE
traintransf['LATITUDE']=LATITUDE
...
Longval = valtransf['LONGITUDE']*np.cos(angle) + valtransf['LATITUDE']*np.sin(angle)
Latival = valtransf['LATITUDE']*np.cos(angle) - valtransf['LONGITUDE']*np.sin(angle)
plt.scatter(Aval,Bval)
valtransf['LONGITUDE']=Longval
valtransf['LATITUDE']=Latival
